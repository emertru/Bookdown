...
You can label chapter and section titles using `{#label}` after them, e.g., we can reference Chapter \@ref(Justifi). If you do not manually label them, there will be automatic labels anyway, e.g., Chapter \@ref(methods).
